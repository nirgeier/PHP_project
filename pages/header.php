<header>
    ...
    <ul class="menuNav">
        ...
        if (isset($_SESSION['user'])) {
            ...
            ?>
            <li><a href="/pages/youtube_search.php"><img src="../images/search.png" title="Search on YouTube"></a></li>
            <li><a href="/pages/details.php?action=update">&nbsp;&nbsp;<img src="../images/profile_edit.png" title="Edit my profile">&nbsp;&nbsp;</a></li>
